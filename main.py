...
# Initialize GithubContents with secrets from Streamlit configuration
...
def main_page():
    ...
    target_language = st.selectbox("Choose language", options=list(languages.keys()))

    # Translate the text
    translated_text = translate_text(original_text, languages[target_language])
